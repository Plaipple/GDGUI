...
public class MainFrame extends JFrame {
    ...
    private JPanel initToolBar()
    {
        ...
        JLabel labelColorLabel = new JLabel();
        labelColorLabel.setText("Label Color:");
        toolBar.add(labelColorLabel);

        JPanel labelColorPanel = new JPanel();
        labelColorPanel.setPreferredSize(new Dimension(60, 20));
        labelColorPanel.setBackground((Color) this.defaultLabelStyle.getTextPaint());
        labelColorPanel.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                super.mouseEntered(e);
                labelColorPanelActionPerformed(labelColorPanel, e);
            }
    ...
    {        
        ...
        JCheckBox checkStress = new JCheckBox();
        checkStress.setSelected(true);
        ...
        randMov.add(stressLabel, randMovConstraints);
        
        randMovConstraints.gridx = 1;
        randMov.add(checkStress, randMovConstraints);
        ...
        executeCrossingRes.addActionListener(new java.awt.event.ActionListener() 
        {
        	...
        	{     
        		try
        		{
        			...
        			final boolean stress = checkStress.isSelected();
        			...
        			{	
        				RandomMovementAlgorithm cr = new RandomMovementAlgorithm(view, iterations)
        				{
        					...
        					{
        						RandomMovementFactory.randomMovement(graph, numberRays, relocateMin, relocateMax, allNodes, doubleValues, iterTillAct, activeIter, crossRes, angRes, numbCross, nodeEdgeDist, edgeLength, stress, maxNoOfIterations);
        					}
        				};       			
    ...
    private void rotateItemActionPerformed(ActionEvent evt) {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            try {
                ...
                this.infoLabel.setText("Wrong parameter passed as rotation angle.");
            }
        }
    }
    ...
    private void scaleItemActionPerformed(ActionEvent evt) {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            try {
                ...
                this.infoLabel.setText("Wrong parameter passed as scale factor.");
            }
        }
    }
    ...
    private void mergeSelectedItemActionPerformed(ActionEvent evt) {
        ...
        {
            final INode base = selection.stream().findFirst().get();

            selection.stream().filter(node -> node != base).forEach(node -> {
                this.graph.neighbors(INode.class, node).forEach(neighbor -> {
    ...
    private void openItemActionPerformed(ActionEvent evt) {
        ...
        if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                this.infoLabel.setText("An error occurred while reading the input file.");
            }
        }
    }
        ...
        if (this.fileNamePath != null) {
            ...
            if (chooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    this.infoLabel.setText("An error occurred while exporting the graph.");
                }
            }
        }
    }
    ...
    private void jpgItemActionPerformed(ActionEvent evt) {
        ...
        if (chooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                this.infoLabel.setText("An error occurred which exporting the graph.");
            }
        }
    }
    ...
    private void christianImportFormatItemActionPerformed(ActionEvent evt) {
        ...
        if (chooser.showOpenDialog(null) == javax.swing.JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                this.infoLabel.setText("An error occurred which importing the graph.");
            }
        }
    }
    ...
    private void labelColorPanelActionPerformed(Object o, MouseEvent e) {
        Color c = JColorChooser.showDialog(null, "Choose a Color", ((JPanel) o).getBackground());
        if (c != null) {
            ((JPanel) o).setBackground(c);
            this.view.getSelection().getSelectedNodes().forEach(u -> {
                SimpleLabelStyle style = (SimpleLabelStyle) u.getLabels().first().getStyle();
                style.setTextPaint(c);
            });
            this.defaultLabelStyle.setTextPaint(c);
            this.view.getSelection().getSelectedNodes().clear();
        }
    }
}
